  ...
  return (
    <div id="contact">
      ...
      <section className="contact__content">
        ...
        <article className="contact__group">
          <span className="contact__category">
            <h2 className="contact__subtitle">E-MAIL</h2>
          </span>
          <span className="contact__data">
            <span className="contact__item">
              <a className="contact__link" href="mailto:ingmultipedroza@gmail.com">
                <img src="icons/enlaceExterno.svg" alt="enlace externo" />
                ingmultipedroza@gmail.com
              </a>
            </span>
          </span>
        </article>
        ...
        <article className="contact__group">
          <span className="contact__category">
            <h2 className="contact__subtitle">REDES SOCIALES</h2>
          </span>
          <span className="contact__data">
            <span className="contact__item">
